...
public:
    ...
    std::string GetHex() const
    {
        ...
        for (unsigned long int i = 0; i < sizeof(pn); i++)
    ...
    void SetHex(const std::string &str)
    {
        ...
        while (phexdigit[static_cast<int>(*psz)] || *psz == '0')
            psz++;
        psz--;
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& out, const uint256& b);
};
inline std::ostream& operator << (std::ostream& out, const uint256& b)
{
    out << b.GetHex().c_str();
    return out;
}
inline std::ostream& operator << (std::ostream& out, const uint160& b)
{
    out << b.GetHex().c_str();
    return out;
}
